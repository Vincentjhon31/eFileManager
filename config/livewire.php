...
return [
    ...
    */
    ...
    /*
     * Class components with plain ASCII filenames, not Livewire 4's default
     * single-file components with a "⚡" prefix.
     *
     * Two reasons, both about this deployment specifically: the app is pushed
     * from Windows to a Linux host and non-ASCII filenames survive that path
     * unpredictably (FTP clients in particular mangle them); and the codebase
     * is handed over to LGU IT staff afterwards, for whom a conventional
     * app/Livewire structure is far easier to pick up.
     */
    'make_command' => [
